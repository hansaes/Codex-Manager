...
pub(super) use super::gateway::{
    ...
    set_gateway_free_account_max_model, set_gateway_global_channel_priority_enabled,
    set_gateway_global_channel_priority_order, set_gateway_model_forward_rules, set_gateway_originator,
